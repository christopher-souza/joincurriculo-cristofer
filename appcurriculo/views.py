...
def curriculo_inicio(request):
	fornacaolist = formacao.objects.order_by('nomecurso').all()
	experiencialist = experiencia.objects.all()
	

	return render(request, 'curriculo.html', {"fornacaolist":fornacaolist, "experiencialist":experiencialist})
